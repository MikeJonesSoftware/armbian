...
function pre_customize_image__set_nanopineo_values { 
	echo "Configuring nanopineo3-specific values..."
...
EOF
	...
	# 	dnssd: mDNS/DNS-SD service discovery via avahi-daemon
...
<service-group>
	...
	<service>
		...
		<port>9000</port>
		<txt-record>nickname=Initialized NanoPi NEO 3 Device</txt-record>
	</service>
</service-group>
AVAHIEOF
